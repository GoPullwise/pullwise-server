...
const DOCUMENT_RULE_HANDLERS = Object.freeze({
  ...
  release_gate_sample_set: ruleReleaseGateSampleSet,
  ...
  task_control_event: ruleTaskControlEvent,
  ...
  task_version_authority_proof: ruleTaskVersionAuthorityProof,
...
function validateDeclaredDocumentRules(schemaId, value) {
  ...
  const signatureContracts = {
    ...
    "release-gate-policy/v1": {algorithm: "Ed25519",
      ...
      encoding: "base64url_no_padding",
      signed_projection: "document_without_signature_and_digest"},
    "release-gate-report/v1": {algorithm: "Ed25519",
      domain: "pullwise-release-gate-report/v1", domain_separator: "NUL",
      encoding: "base64url_no_padding",
      signed_projection: "document_without_signature_and_digest"},
