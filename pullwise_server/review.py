...
def _run_mock(*, repo: str, branch: str, commit: str) -> list[dict]:
    ...
    return [
        ...
        },
        {
            ...
            "reproductionPath": "Open the dashboard with an account that has 50+ repositories. Open DevTools Network tab and observe the waterfall of /projects/stats requests.",
            ...
            "autoFix": False,
            "effort": "20 min",
            "fixBenefits": "Collapsing 100 individual requests into one batched call reduces P95 dashboard load time from ~3s to ~400ms for large accounts.",
