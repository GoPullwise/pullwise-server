...
_DOCUMENT_RULE_HANDLERS = {
    ...
    "committed_checkpoint_manifest": _rule_committed_checkpoint_manifest,
    ...
    "machine_checkpoint": _rule_machine_checkpoint,
    ...
    "release_signing_key": _rule_release_signing_key,
    ...
    "semantic_checkpoint": _rule_semantic_checkpoint,
    ...
    "task_control_event": _rule_task_control_event,
    ...
    "task_version_authority_proof": _rule_task_version_authority_proof,
