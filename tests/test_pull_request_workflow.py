...
class PullRequestWorkflowTest(unittest.TestCase):
    ...
    def test_existing_pull_request_payload_is_sanitized_before_returning(self) -> None:
    ...
    def test_malformed_repository_access_is_rejected_before_checkout_or_git(self) -> None:
        ...
        with (
            ...
            with self.assertRaisesRegex(ValueError, "Authorize GitHub repositories"):
                app.create_issue_pull_request(app.USERS["usr_1"], app.ISSUES[0])
    ...
    def test_issue_read_routes_sanitize_pull_request_payloads(self) -> None:
        app.ISSUES[0]["pullRequest"] = {
            "issueId": {"value": "f_123"},
            "branch": "pullwise/fix-f_123-existing\r\nX-Injected: bad",
            "url": "javascript:alert(1)",
