...
class WorkerAdminRoutesTest(unittest.TestCase):
    ...
    def test_admin_can_create_worker_and_token_is_only_returned_once_as_hash(self) -> None:
        ...
        self.assertEqual(payload["suggested_env"]["PULLWISE_CODEX_MODEL"], "")
        self.assertEqual(payload["suggested_env"]["PULLWISE_CODEX_REASONING_EFFORT"], "xhigh")
        self.assertEqual(payload["suggested_env"]["PULLWISE_OPENCODE_COMMAND"], "opencode")
        self.assertEqual(payload["suggested_env"]["PULLWISE_OPENCODE_MODEL"], "")
        self.assertEqual(payload["suggested_env"]["PULLWISE_OPENCODE_VARIANT"], "")
