...
class _VerificationDirectGraphHarnessProtocol(Protocol):
...
class VerificationDirectGraphBuilderMixin:
    def build_graph(
        self: _VerificationDirectGraphHarnessProtocol,
    ) -> dict[str, object]:
        ...
        pre_manifest["entries"][0]["observation_seq"] = owner_observation[
            "observation_seq"
        ]
        pre_manifest["entries"][0]["source_state_before_id"] = original_source[
            "source_state_id"
        ]
        pre_manifest["entries"][0]["source_state_after_id"] = original_source[
            "source_state_id"
        ]
        ...
        final_manifest["entries"][1]["observation_id"] = verifier_observation[
            "observation_id"
        ]
        final_manifest["entries"][1]["observation_seq"] = verifier_observation[
            "observation_seq"
        ]
        final_manifest["entries"][1]["source_state_before_id"] = final_source[
            "source_state_id"
        ]
        final_manifest["entries"][1]["source_state_after_id"] = final_source[
            "source_state_id"
        ]
        final_manifest = self.reseal("observation-manifest/v1", final_manifest)
        execution_state = self.fixture_document(
            "source_evidence_golden_execution_state"
        )
        ...
        verifier_work["verifier_input_manifest_digest"] = verifier_input[
        ...
        attestation["verifier_input_manifest_digest"] = verifier_input[
            "input_manifest_digest"
        ]
        ...
        attestation["final_observation_manifest_digest"] = final_manifest[
            "manifest_digest"
        ]
        ...
        aggregate = self.fixture_document(
        ...
        aggregate["final_observation_manifest_digest"] = final_manifest[
            "manifest_digest"
        ]
