...
- In the supported single-hop trusted-proxy deployment, derive `X-Forwarded-For` client identity from the rightmost appended address. Never use the client-controlled leftmost entry for rate-limit subjects.
